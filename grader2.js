...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url>', 'URL for the file', String, 'none')
        .parse(process.argv);
...
//	    console.log("got data:"+data);
	    checkJson = checkHtmlText(data, program.checks);
	    outJson = JSON.stringify(checkJson, null, 4);
	    console.log(outJson);
	}).on('fail', function (data, response) {
	    console.log("could not retrieve url: response code " + response.statusCode);
	    process.exit(1);
	});
    }
} else {
